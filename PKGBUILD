...
license=('GPL')
depends=('kactivities-git' 'kdelibs4support' 'exiv2' 'libkdcraw-git' 'libkipi-git' 'phonon-qt5-git' 'kimageannotator-git' 'kcolorpicker-git')
makedepends=('extra-cmake-modules' 'git' 'kdoctools' 'python' 'baloo-git' 'purpose-git' 'cfitsio')
